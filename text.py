...
class Tokenizer(object):
    ...
    def fit_on_texts(self, texts):
        ...
        self.word_index = dict(list(zip(sorted_voc[:(self.num_words-2)], list(range(1,self.num_words-1)))))
        self.index_word = dict(list(zip(list(range(1,self.num_words-1)),sorted_voc[:(self.num_words-2)])))
        ...
        '''for w, c in list(self.word_docs.items()):
            if(w in self.word_index):
                ...
                self.index_docs[self.word_index[self.oov_token]] += c '''
